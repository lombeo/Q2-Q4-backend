...
namespace Api_Project_Prn
{
    public static class HostingExtensions
    {
        public static void ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<IVolumeDiscountService, VolumeDiscountService>();
            ...
            builder.Services.AddDbContext<BackendInterviewContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("DefaultConnection")));
            builder.Services.AddScoped<BackendInterviewContext>();
        }
        ...
        private static void InitializeDatabase(IApplicationBuilder app)
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetService<BackendInterviewContext>();
